...
namespace Cubethon
{
    ...
    public sealed class MoveCommand : MovementCommand
    {
        ...
        public MoveCommand(float steering) { this.steering = steering; }
        public override void Execute(PlayerMovement player) { player.ApplyMovement(steering); }
    }
    ...
    public sealed class PlayerMovement : MonoBehaviour
    {
        ...
        public bool HasRecording { get { return commands.Count > 0; } }

        private readonly List<MovementCommand> commands = new List<MovementCommand>();
        ...
        private void Update()
        {
            if (!IsReplaying) horizontal = GameInput.Horizontal;
        }
        ...
        public void ApplyMovement(float steering)
        {
            ...
            rb.AddForce(0f, 0f, forwardForce * step, ForceMode.Force);
            rb.AddForce(steering * sidewaysForce * step, 0f, 0f, ForceMode.VelocityChange);
        }
